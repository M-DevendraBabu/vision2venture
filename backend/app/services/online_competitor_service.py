        ...
        try:
            ...
            for wc in web_comps:
                ...
                competitors.append({
                    ...
                    "description": wc.get("description") or (f"Online digital service operating on {c_dom}. {cust_sentiment}." if cust_sentiment else f"Online digital service operating on {c_dom}."),
                    ...
                    "analysis_explanation": (f"Discovered via live search engine intelligence ({c_dom}, {cust_rating}★ customer rating)." if cust_rating is not None else f"Discovered via live search engine intelligence ({c_dom}); no customer rating available."),
        ...
        try:
            ...
            for m in yc_matches:
                ...
                competitors.append({
                    ...
                    "business_type": "online",
                    "competitor_type": c_type,
                    "description": f"{one_liner} {cust_sentiment}." if cust_sentiment else one_liner,
                    ...
                    "similarity_score": sim_score,
                    "relevance_score": sim_score,
                    "strengths": m.get("strengths") or f"• Y Combinator-backed platform operating in {industry}.",
                    "weaknesses": m.get("weaknesses") or "• Likely gap: complex enterprise onboarding. No customer review data was retrieved for this competitor.",
