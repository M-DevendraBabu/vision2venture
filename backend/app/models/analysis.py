...
class MarketAnalysis(Base):
    ...
    primary_demo = Column(Text, nullable=True)
    key_pain_point = Column(Text, nullable=True)
    acquisition_channel = Column(String(500), nullable=True)
...
class FinancialAnalysis(Base):
    ...
    gross_margin_percent = Column(DECIMAL(5, 2), nullable=True, default=None)
    break_even_months = Column(Integer, nullable=True, default=None)
    year1_revenue = Column(DECIMAL(18, 2), nullable=True, default=None)
    year2_revenue = Column(DECIMAL(18, 2), nullable=True, default=None)
